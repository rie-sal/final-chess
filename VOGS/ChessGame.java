...
public static void main(String[] args) throws IOException{
        ...
        while (true) {
            // stalemate check
            if(board.isStalemate(currentPlayer[0].equals("black") ? "black" : "white"))  
           ...
           if ( board.isInCheck(currentPlayer[0].equals("black") ? "black" : "white")){
            ...
            board.frame.addMouseListener(new MouseListener() {
                ...
                public void mouseReleased(MouseEvent e) {
                    ...
                    if (selectedX[0] == e.getX()/64 && selectedY[0] == e.getY()/64 && click == false){
                        click = true;
                    }
                    else if (click){
                        click = false;
